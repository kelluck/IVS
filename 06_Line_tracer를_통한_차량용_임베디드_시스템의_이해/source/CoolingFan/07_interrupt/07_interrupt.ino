...
#define PIN_SWITCH_BLACK 2 //INTERRUPT PIN!!
...
void setup() {
  attachInterrupt(digitalPinToInterrupt(PIN_SWITCH_BLACK), isrSwitchBlack, RISING); // INTERRUPT 초기화!!!!
...
void isrSwitchBlack() // INTERRUPT SERVICE ROUTINE!!!
{
  rotateFlag = 0;
