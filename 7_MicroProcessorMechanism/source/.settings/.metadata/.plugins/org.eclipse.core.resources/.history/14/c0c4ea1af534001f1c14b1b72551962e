...
void Driver_Stm_Init(void)
{
    ...
    g_Stm.stmConfig.ticks = 5000000u; //10만번 counting했을 때 1ms// 5000000번 50ms
...
void STM_Int0Handler(void)
{
    ...
    IfxStm_increaseCompare(g_Stm.stmSfr, g_Stm.stmConfig.comparator, 5000000u); // 5000000번 50ms
