...
// DIR A PIN init
#define DIRA &MODULE_P10,1
// BRAKE A PIN init
#define BRAKEA &MODULE_P02,7
...
void core0_main(void)
{
    ...
    // DIR A PIN init
    IfxPort_setPinModeOutput(DIRA, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
    IfxPort_setPinLow(DIRA);
    //BRAKE A PIN init
    IfxPort_setPinModeOutput(BRAKEA, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
    IfxPort_setPinLow(BRAKEA);
